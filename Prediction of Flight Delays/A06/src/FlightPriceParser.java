...
public class FlightPriceParser{
	//set DEV_MODE to true if you want to get malformed data to display
	...
	public boolean map(String nline){
		...
		double tArrDel15;
		try{
			tArrDel15 = Double.parseDouble(readline[44]);
		}catch(NumberFormatException e)
		{
			if (DEV_MODE)
		...
		if (ArrDelayMinutes >= 15 && ArrDel15 != true){
			if (DEV_MODE)
				System.out.println("ArrDelay > 0");
			return false;
		}
